      ...
      <div className="flex flex-col justify-center items-center">
        ...
        <div className="max-w-[600px]">
          ...
          <ul className="list-disc list-inside flex flex-col gap-2">
            <li>
              Google auth tokens: We store your Google tokens for hassle-free
              user experience by avoiding repeated authorizations.
            </li>

            <li>
              Google calendar id: We store a newly generated Google Calendar Id
              to ensure proper service functionality.
            </li>

            <li>
              Google email address: Send you very occasional emails related to
              our product, updates, and important notifications.
            </li>
          </ul>
          <div className="mt-10">
            <H2>Full Policy</H2>
            ...
            <p>
              We use your Google email address to send you very occasional
              emails, such as product updates and important notifications
              related to our service.
            </p>
            <H3>b. Calendar Integration</H3>
            <p>
              Your Google tokens and CalendarId are used to integrate and
              interact with your Google Calendar. This allows you to efficiently
              manage your menstrual cycle-related events and productivity goals.
            </p>
            <H2> 4. Data Security</H2>
            <p>
              We take the security of your data seriously and implement
              reasonable safeguards to protect it from unauthorized access,
              disclosure, alteration, or destruction. However, please be aware
              that no data transmission over the internet or data storage system
            ...
            <p>
              ...
              purposes outlined in this Privacy Policy. You may request the
              removal of your data by contacting us at {emailUs}.
            </p>
            <H2>6. Sharing Your Information</H2>
            <p>
              We do not share your personal information with third parties,
              except when required by law or as described in this Privacy
              Policy.{" "}
            </p>
            <H2>7. Your Rights</H2>
            You have the right to: - Access the personal information we hold
            about you. - Correct any inaccuracies in your personal information.
            - Delete your personal information. - Object to the processing of
            ...
            <p>
              ...
              practices or legal requirements. The updated Privacy Policy will
